...
public class BaseRefreshFooterView extends LinearLayout implements MyRefreshFooter2 {
    public BaseRefreshFooterView(Context context) {
        super(context);
        init();
    }

    public BaseRefreshFooterView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BaseRefreshFooterView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BaseRefreshFooterView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
